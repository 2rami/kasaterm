...
fn english(value: &str) -> Option<&'static str> {
    Some(match value {
        ...
        "새 방의 시작 폴더" => "Startup folder for new rooms",
        "파일을 여는 곳" => "Open files with",
        "편집기 자동 저장" => "Editor autosave",
        "휠 스크롤 속도" => "Wheel scroll speed",
        "생각 깊이" => "Reasoning effort",
        "커서 굵기" => "Cursor thickness",
        "카사텀" => "kasaterm",
        "앱" => "App",
        "터미널" => "Terminal",
        "기본 앱" => "Default app",
        ...
        "모양만 고르면 색은 현재 캐릭터를 따라가요" => "Choose a shape; its color follows the current character",
        "고급" => "Advanced",
        "고급 · 기존 설정" => "Advanced · existing setting",
        "블록" => "Block",
        "빔" => "Beam",
        "밑줄" => "Underline",
        "프레임" => "Frame",
        ...
        "모서리" => "Corners",
        "실제 깜빡임" => "Live blink",
        "블록은 셀 전체를 채워 굵기를 쓰지 않아요" => "Block fills the whole cell and does not use stroke width",
        "선 굵기" => "Stroke width",
        ...
        "보이는 정보와 순서, 색을 내 작업에 맞춥니다" => "Choose the information, order, and colors that fit your work",
        "실시간 미리보기 예시" => "Live preview example",
        "고른 순서와 색, 구분선을 창 맨 아래와 같은 흐름으로 보여 줍니다" => "Shows the chosen order, colors, and separators in the bottom-bar flow",
        "표시 항목" => "Visible items",
        "표시 항목 없음" => "No visible items",
        "체크는 보이기, 화살표는 순서, 색 칸은 항목의 강조색입니다" => "Use checks for visibility, arrows for order, and swatches for item color",
        ...
        "펫 상태" => "Pet status",
        "펫" => "Pet",
        "바탕화면에 서서 학생들 상황을 알려 주는 캐릭터입니다" => "A desktop companion that reacts to your agents",
        "바탕화면에 띄우기" => "Show desktop pet",
        "kasaterm을 내려도 바탕화면에 남습니다" => "Stays on your desktop when kasaterm is minimized",
        "받아 둔 캐릭터가 없습니다 — 펫을 처음 켜면 받아 옵니다" => "No characters yet. Turn on the pet to download one",
        "모습" => "Appearance",
        "펫 크기" => "Pet size",
        ...
        "자동 움직임" => "Automatic animation",
        "위치 고정" => "Lock position",
        "자동 휴식" => "Rest after inactivity",
        "안 함" => "Off",
        "분" => "m",
        "초" => "s",
        "알림" => "Notifications",
        "말풍선 표시" => "Show speech bubbles",
        "작업 상태에 반응" => "React to task status",
        ...
        "창 맨 아래 · 예시" => "Window bottom · example",
        "지메일" => "Gmail",
        "개인" => "Personal",
        "5h 미제공" => "5h unavailable",
        "펫 2명" => "2 pets",
        "모바일 연결됨" => "Mobile connected",
        "색" => "Color",
        ...
        "새 판 보내기" => "Send current build",
        "연결됨" => "Connected",
        "연결됨 · 빌드 다름" => "Connected · build differs",
        ...
        "사용할 캐릭터" => "Characters to use",
        "앱 테마와 관계없이 여러 명단에서 함께 고릅니다" => "Mix characters from any collection, independently of the app theme",
        "새 대화에 사용할 명단이에요. 앱 테마와 따로 고르고, 같은 이름·그림은 새 선택으로 교체해요." => "Used for new conversations, independently of the app theme. Matching names or artwork are replaced by the new choice.",
        "테마를 섞어 사용할 캐릭터를 고릅니다" => "Mix characters from different collections",
        "선택한 캐릭터가 없으면 기본 명단을 사용해요." => "Without a custom selection, the default collection is used.",
        "다른 명단과 함께 사용할 캐릭터를 고릅니다" => "Choose characters to use alongside other collections",
        "최소 한 명은 선택해 주세요" => "Keep at least one character selected",
        "선택 해제" => "Deselect",
