...
fn english(value: &str) -> Option<&'static str> {
    Some(match value {
        ...
        "자주 쓰는 모양과 꾸미기 모양을 나눠 골라요" => "Choose from everyday and decorative cursor shapes",
        "고급" => "Advanced",
        ...
        "커서 색" => "Cursor color",
        "커서에만 적용되고 테마 강조색은 그대로예요" => "Applies only to the cursor; the theme accent stays unchanged",
        "선 굵기" => "Stroke width",
        "현재" => "Current",
        "파랑" => "Blue",
        "초록" => "Green",
