...
export const ko = {
  ...
  titles: {
    ...
    pet: { title: '펫', hint: '바탕화면에 서서 학생들 상황을 알려 주는 캐릭터' },
  ...
  appearance: {
    ...
    palette: '팔레트',
    paletteHint: '고칠 칸을 누르고 휠에서 색을 잡으세요 — #rrggbb 를 쳐도 됩니다',
    wheelHint: '원을 끌면 색상과 진하기, 옆 띠를 끌면 밝기 — 끄는 동안 화면이 따라와요',
    eyedropper: '화면에서 집기',
    eyedropperHint: '다른 앱 위에서도 집을 수 있어요',
    eyedropperWaiting: '집는 중…',
    ...
    deviceColors: '기기 색',
    deviceColorsHint: 'pane 헤더·배치도·정보 탭이 기기를 이 색으로 갈라요 — 줄을 누르면 휠이 열립니다',
    deviceLocal: '이 기기',
    deviceDefault: '기본값',
    deviceReset: '기본값으로',
    deviceResetAll: '모든 기기 색 기본값으로',
    devicePresets: '프리셋 — 서로 갈라 보이는 다섯 색',
    deviceNone: '아직 이름을 알아낸 기기가 없어요',
    deviceHexHint: '#rrggbb 말고 rgb(r, g, b) · r, g, b 도 받아요',
    ansi: '터미널 ANSI',
...
export const en: Strings = {
  ...
  titles: {
    ...
    pet: { title: 'Pet', hint: 'A desktop character that reports on your students' },
  ...
  appearance: {
    ...
    palette: 'Palette',
    paletteHint: 'Pick the swatch to edit, then grab a color on the wheel — or type #rrggbb',
    wheelHint: 'Drag the circle for hue and saturation, the strip for brightness — the app follows as you drag',
    eyedropper: 'Pick from screen',
    eyedropperHint: 'Works over other apps too',
    eyedropperWaiting: 'Picking…',
    ...
    deviceColorsHint: 'Pane headers, the layout map and the Info tab tell devices apart by these — pick a row to open the wheel',
    deviceLocal: 'this device',
    deviceDefault: 'default',
    deviceReset: 'Use default',
    deviceResetAll: 'Reset every device color',
    devicePresets: 'Presets — five colors that stay apart',
    deviceNone: 'No device names known yet',
    deviceHexHint: 'Besides #rrggbb, rgb(r, g, b) and r, g, b work too',
    ansi: 'Terminal ANSI',
